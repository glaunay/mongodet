...
columns = ["name","vol","color","complete_name","Molecular_formula","MM","CMC_(mM)","Aggregation_number","Ref","PDB_file","detergent_image","SMILES"] # because columns are in french, we have to translate them to english
